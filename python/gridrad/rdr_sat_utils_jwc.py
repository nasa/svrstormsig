...
def sat_time_intervals(sat, sector = None):
    ...
    if sat.lower() == 'goes16' or sat.lower() == 'goes17' or sat.lower() == 'goes18' or sat.lower() == 'goes19':
        if sector == None:
        ...
        if sector[0].lower() == 'f':
            ...
            print('sector specified not found??')
            print('Specified sector = ' + str(sector))
            print('Sectors for MTG satellite are Full')
            exit()
    else:
...
def extract_us_lat_lon_region(region, exact = False):
    ...
    domain = {
              ...
              'central plains'                               : [-104.0, 32.0, -75.0, 47.0],
              'custom1'                                      : [-97.5, 28.0, -105.0, 36.0],#Custom region
              'custom2'                                      : [-105.0, 33.5, -94.0, 41.0],
              'custom3'                                      : [-102, 30.0, -75.0, 44.0],
              'custom4'                                      : [-106.645646, 24.523096, -80.031362, 36.5],
              '20211210_outbreak'                            : [-94.5, 33.0, -84.0, 42.0], 
              ...
              '2019146-147_region4'                          : [-106.0, 37.002206, -98.0, 41.1], #Narrow region ever further around Colorado
              ...
              'the democratic republic of the congo'         : [12.0, -14.2726671, 32.0, 5.5], 
              'democratic republic of the congo'             : [12.0, -14.2726671, 32.0, 5.5], 
              'republic of the congo'                        : [11.0, -5.0, 19.0, 4.0], 
              ...
              'benelux'                                      : [1.0, 48.0, 9.0, 57.0],
              'balkans'                                      : [12.0, 40.0, 30.5, 50.0],
              'alps-tatra'                                   : [9.0, 45.0, 23.0, 51.5], 
              'nordic'                                       : [4.5, 55.5, 40.0, 71], 
              'iberia'                                       : [-10.5, 35.0, 5.0, 45.0], 
...
def extract_us_lat_lon_region_parallax_correction(region):
    ...
    pc = {
          ...
          'central plains'               : [0.07278328, 0.14013281],
          'custom2'                      : [0.11870096, 0.13546413],
          'custom3'                      : [0.07278328, 0.14013281],
          'custom4'                      : [0.065283276, 0.098906524],
          ...
          '2019146-147_region3'          : [0.11870096, 0.13546413],
          '2019146-147_region4'          : [0.11870096, 0.13546413],
          '2020134-135_region'           : [0.15, 0.10],
          '2019125-126_m2_region'        : [0.11014652, 0.11942014],
...
def extract_mtg1_lat_lon_region_parallax_correction(region):
    '''
    Uses switch in order to return the latitude and longitude parallax corrections for regions from MTG-1 satellite
    Args:
        region : State or sector to get latitude and longitude data for
    Keywords:
        None.
    Returns:
        pc : Longitude and latitude parallax corrections in degrees [x_pc, y_pc]
    ...
    region = region.lower()
    pc = {
          'connecticut'                                 : [2.4087451511470306, 0.3984836776746832], 
          'delaware'                                    : [3.7739734052185128, 0.5453052218170882], 
          'district of columbia'                        : [6.972154372771385, 1.004721682306517], 
          'washington dc'                               : [6.972154372771385, 1.004721682306517], 
          'maine'                                       : [1.7545780352841263, 0.35199276167337956], 
          'maryland'                                    : [8.023070173852716, 1.1752781802367096], 
          'massachusetts'                               : [2.0937850635843347, 0.3650709977990729], 
          'new hampshire'                               : [2.315703284215161, 0.4113943240513578], 
          'new jersey'                                  : [3.3530053574603187, 0.5029973770365217], 
          'new york'                                    : [6.044517442258552, 0.9330201209834286], 
          'pennsylvania'                                : [15.180043065298882, 2.729000123295549], 
          'puerto rico'                                 : [0.5710157161094997, 0.07486346211010897], 
          'rhode island'                                : [1.9670200627603407, 0.34542748894273956], 
          'united states virgin islands'                : [0.5088162519767394, 0.07112602351066499], 
          'virgin islands'                              : [0.5088162519767394, 0.07112602351066499], 
          'vermont'                                     : [2.665584740622876, 0.45541628284210134], 
          'northeast'                                   : [12.645304655036874, 2.287199835240095], 
          'hurricane_sam21'                             : [0.21436847207424137, 0.04462201610116345], 
          'hurricane_dorian19'                          : [2.2306448019040346, 0.2398644940482093], 
          'argentina'                                   : [0.7831084334923801, -0.19248512035340326], 
          '2018284-2018285_C_region'                    : [10.761584620914888, 1.6102751093046095], 
          '2019304-2019305_C_region'                    : [19.154503334684932, 3.514133345980241], 
          'central_europe'                              : [-0.08763660512131466, 0.1973534021602532], 
          'central_europe2'                             : [-0.07312343689161338, 0.19696020108450085], 
          'aruba'                                       : [0.709247460411035, 0.05556173083569682], 
          'afghanistan'                                 : [-0.918300035385542, 0.178176333315335], 
          'angola'                                      : [-0.05499854430174267, -0.032734980551579085], 
          'anguilla'                                    : [0.4602297351169824, 0.07037747653737014], 
          'aland islands'                               : [-0.2951004781969644, 0.3498779492220976], 
          'albania'                                     : [0.91680717006669, 0.056591393730652584], 
          'andorra'                                     : [-0.008850268069469758, 0.15824153207402247], 
          'netherlands antilles'                        : [0.6451123456447618, 0.05188578014911904], 
          'united arab emirates'                        : [-0.3139124048607371, 0.08653797539890817], 
          'armenia'                                     : [1.3818449735293399, 0.02878565284153556], 
          'antarctica'                                  : [0.0, -0.8613479132941251], 
          'french southern territories'                 : [-0.45446217065960326, -0.12272733688293158], 
          'antigua and barbuda'                         : [0.4224043666440238, 0.06437011579281204], 
          'austria'                                     : [-0.09263328893693057, 0.19513638521627996], 
          'azerbaijan'                                  : [-0.3642378315568422, 0.16326486911843574], 
          'burundi'                                     : [-0.09653221287961244, -0.009902739488490298], 
          'belgium'                                     : [-0.03394171023838766, 0.21754389650023143], 
          'benin'                                       : [-0.016323601590515047, 0.01818074810075032], 
          'burkina faso'                                : [0.004654513724328568, 0.03561436733608758], 
          'bulgaria'                                    : [-0.15691345176927385, 0.16360982077273434], 
          'bahrain'                                     : [-0.2789366268369733, 0.09095216601593137], 
          'bahamas'                                     : [2.356715912578707, 0.22803032402759627], 
          'bosnia and herzegovina'                      : [-0.10740084821655671, 0.16891410495220072], 
          'saint barthelemy'                            : [0.4470853140460491, 0.06767897254988497], 
          'belarus'                                     : [-0.28803653539015883, 0.2606912427612116], 
          'bermuda'                                     : [0.691044951476016, 0.1492639442091459], 
          'bolivia'                                     : [0.4573270407952208, -0.06174750811298324], 
          'brazil'                                      : [0.2416293871116011, -0.04642725808855275], 
          'barbados'                                    : [0.3511557468311608, 0.046135737840595326], 
          'bouvet island'                               : [-0.031690488190577515, -0.2572761074966081], 
          'botswana'                                    : [-0.09019286324467402, -0.06904655533501014], 
          'central african republic'                    : [-0.3372569071958935, 0.09088492320519848], 
          'switzerland'                                 : [-0.0541101983931469, 0.1874800722652452], 
          'cote divoire'                                : [0.016185727468524647, 0.021430274770372293], 
          'ivory coast'                                 : [0.016185727468524647, 0.021430274770372293], 
          'cameroon'                                    : [-0.03637060559255367, 0.02124357773867036], 
          'the democratic republic of the congo'        : [-0.06719930505600757, -0.012686627654130866],
          'democratic republic of the congo'            : [-0.06719930505600757, -0.012686627654130866],
          'republic of the congo'                       : [-0.04403449947773197, -0.0014342032481413636],
          'congo'                                       : [-0.04349348018706678, -0.0020593968833860776], 
          'colombia'                                    : [1.1384955179541265, 0.03353732782078378], 
          'comoros'                                     : [-0.1750641365897181, -0.03676360045420424], 
          'cape verde'                                  : [0.08035328027778377, 0.047824865043338605], 
          'cuba'                                        : [8.0256221766695, 0.6995255478936997], 
          'cayman islands'                              : [37.61252539528834, 5.756479956626864], 
          'cyprus'                                      : [-0.1704049374711758, 0.12288214036883005], 
          'czech republic'                              : [-0.11922010254867921, 0.213288722422881], 
          'germany'                                     : [-0.08442519702842688, 0.22458852419641318], 
          'djibouti'                                    : [-0.16721305843992695, 0.03646363559678889], 
          'dominica'                                    : [0.3972291236723109, 0.05589875513559406], 
          'denmark'                                     : [-0.12429341671021987, 0.28116325072110726], 
          'dominican republic'                          : [0.7896279665154111, 0.09093640192923402], 
          'algeria'                                     : [-0.0062169628261432575, 0.0890470569420252], 
          'egypt'                                       : [-0.1285685144065951, 0.08689779576201317], 
          'eritrea'                                     : [-0.33723526772595847, 0.0908938974451523], 
          'western sahara'                              : [0.04896458420415861, 0.07472757570209154], 
          'spain'                                       : [0.03101762809002473, 0.12165643931034253], 
          'estonia'                                     : [-0.3389355805055523, 0.3290525971562417], 
          'ethiopia'                                    : [-0.1504658857402177, 0.027688993212521495], 
          'finland'                                     : [-0.5697520947813075, 0.473210052405193], 
          'fiji'                                        : [0.0, -0.05062790106590498], 
          'falkland islands (malvinas)'                 : [1.163548992414654, -0.3399774915643192], 
          'falkland islands'                            : [1.163548992414654, -0.3399774915643192], 
          'malvinas'                                    : [1.163548992414654, -0.3399774915643192], 
          'france'                                      : [-0.014072656556383567, 0.1829933970179738], 
          'faroe islands'                               : [0.10903133621168148, 0.375066470483425], 
          'gabon'                                       : [-0.03343646617771512, -0.0025523825609954365], 
          'united kingdom'                              : [0.04335045207128552, 0.2592212788987709], 
          'uk'                                          : [0.04335045207128552, 0.2592212788987709], 
          'guernsey'                                    : [0.018964887586408796, 0.20809049957970416], 
          'ghana'                                       : [0.002894855724895229, 0.022601291401895374], 
          'gibraltar'                                   : [0.024290294633516396, 0.12363907581898559], 
          'guinea'                                      : [8.225422005507681, 1.1924997027891848], 
          'guadeloupe'                                  : [0.40201588648845643, 0.059018535469675726], 
          'gambia'                                      : [0.04808086823437563, 0.03944439442874348], 
          'guinea-bissau'                               : [0.04689396329330542, 0.03404338301128362], 
          'essl'                                        : [-0.09457169958537293, 0.18990192533476602], 
          'benelux'                                     : [-0.04262903655600958, 0.23659745326875026], 
          'balkans'                                     : [-0.13743727133819306, 0.17733855931999898], 
          'alps-tatra'                                  : [-0.11510321507665644, 0.2002537498054906],
          'nordic'                                      : [-0.4226734597495643, 0.42194448945737406], 
          'iberia'                                      : [0.013967706962856319, 0.14348818596146629],
          'equatorial guinea'                           : [-0.024166318373954, 0.0033110560901128405], 
          'greece'                                      : [-0.12792160581880196, 0.13683941311902714], 
          'grenada'                                     : [0.3890741276073797, 0.04372155483989282], 
          'greenland'                                   : [1.9538609644052372, 0.3569369221881331], 
          'french guiana'                               : [0.24430553405877475, 0.012574191556382619], 
          'guyana'                                      : [0.3221596645167537, 0.01654713331608093], 
          'heard island and mcdonald islands'           : [-9.139030459912632, -1.7340169894419262], 
          'croatia'                                     : [-0.10025074743481355, 0.17159883317192737], 
          'haiti'                                       : [3.504535341574041, 0.2917873396246691], 
          'hungary'                                     : [-0.1363680518596162, 0.19271288179802326], 
          'isle of man'                                 : [0.04258424599680133, 0.25528100232135387], 
          'british indian ocean territory'              : [-0.8171044167213211, -0.030011013611802362], 
          'ireland'                                     : [0.07516345583674067, 0.246916802150551], 
          'islamic republic of iran'                    : [-0.370188300113071, 0.12363683034705275], 
          'iran'                                        : [-0.370188300113071, 0.12363683034705275], 
          'iraq'                                        : [-0.24905425703985884, 0.11936826896080532], 
          'iceland'                                     : [-0.004396476094785551, 0.2253569973544387], 
          'israel'                                      : [-0.16816079601461098, 0.106698797560977], 
          'italy'                                       : [-0.06854924070498392, 0.15104144071453618], 
          'jamaica'                                     : [2.2782137950796795, 0.16321293982436558], 
          'jersey'                                      : [0.015440696412438282, 0.20595437167114028], 
          'kazakhstan'                                  : [-1.651792043518796, 0.36460736485123135], 
          'kenya'                                       : [-0.13237497310050372, -0.0004150823340594023], 
          'kyrgyzstan'                                  : [-3.6567546530809096, 0.5563920927817492], 
          'saint kitts and nevis'                       : [0.439499176640723, 0.06478520465296711], 
          'kuwait'                                      : [0.9623561309954454, -0.06215657824474441], 
          'lebanon'                                     : [6.070967441437503, 0.8922387920007182], 
          'liberia'                                     : [0.027747000551480383, 0.0182624613900213], 
          'libyan arab jamahiriya'                      : [-0.06531899683044529, 0.0832283270468217], 
          'saint lucia'                                 : [0.3822805418933939, 0.04973808901245036], 
          'liechtenstein'                               : [-0.06399527398209237, 0.19027183656854163], 
          'sri lanka'                                   : [-0.33743901201152227, 0.09094067269231587], 
          'lesotho'                                     : [-0.12139647583655488, -0.0972963388783441], 
          'lithuania'                                   : [-0.25601402262178397, 0.2749838219892524], 
          'luxembourg'                                  : [-0.041400516814339205, 0.21264760556633178], 
          'latvia'                                      : [-0.2946822296366385, 0.29922184619016434], 
          'macao'                                       : [-0.3374683033710113, 0.09096801446733238], 
          'saint martin'                                : [0.45449127432296876, 0.06857278370115338], 
          'morocco'                                     : [0.03484360068817338, 0.09142924795429508], 
          'monaco'                                      : [-0.043200802338343, 0.16606629083949542], 
          'republic of moldova'                         : [-0.22089571294703703, 0.19380029702020352], 
          'moldova'                                     : [-0.22089571294703703, 0.19380029702020352], 
          'madagascar'                                  : [-0.21205602255368206, -0.06072232823963475], 
          'maldives'                                    : [-0.33742968853621846, 0.0909252065824191], 
          'the former yugoslav republic of macedonia'   : [-0.12447211139020808, 0.1553986730352932], 
          'macedonia'                                   : [-0.12447211139020808, 0.1553986730352932], 
          'mali'                                        : [0.012622338465519078, 0.05215207322891047], 
          'malta'                                       : [-0.06644835779429314, 0.12338052296542656], 
          'montenegro'                                  : [0.314440546147317, -0.10812858087765065], 
          'mauritania'                                  : [-0.3371183215282798, 0.09086478340454818], 
          'montserrat'                                  : [0.4238030498781171, 0.062118578621298326], 
          'martinique'                                  : [0.3863184589199591, 0.05264402823951109], 
          'mauritius'                                   : [-0.36969487950952384, -0.05495924696730903], 
          'malawi'                                      : [-0.12188859419254783, -0.03990456656974928], 
          'mayotte'                                     : [-0.1855068124250181, -0.04001029059548955], 
          'namibia'                                     : [-0.0654013137385725, -0.07070372089111387], 
          'niger'                                       : [-0.025759230399508226, 0.05230867001564832], 
          'nigeria'                                     : [-0.025665256027183503, 0.02592253879828732], 
          'netherlands'                                 : [0.14529160534070584, 0.11160554775999287], 
          'norway'                                      : [-0.37053890787100485, 0.4520489647841117], 
          'new zealand'                                 : [-0.0007981845645000096, -0.1486618486840925], 
          'oman'                                        : [-0.33734287548962527, 0.09092879812913424], 
          'pakistan'                                    : [-0.9210801206654082, 0.15755161895842562], 
          'palau'                                       : [-0.01639880649055181, 0.15842258076639126], 
          'poland'                                      : [-0.16767680948343866, 0.23578111319747563], 
          'portugal'                                    : [0.08915418503248418, 0.12423106406001949], 
          'paraguay'                                    : [0.383262475528781, -0.08642396327040558], 
          'qatar'                                       : [-0.3372915226284334, 0.09092612607067352], 
          'reunion'                                     : [-0.31885777365724266, -0.07395070461607034], 
          'romania'                                     : [-0.1737833893897438, 0.18569282906583595], 
          'rwanda'                                      : [-0.09610542299392932, -0.0056712058008880906], 
          'sudan'                                       : [-0.019387802991411185, 0.03160078394001431], 
          'senegal'                                     : [0.04572173690569059, 0.0425699861333424], 
          'south georgia and the south sandwich islands': [0.4469663133988604, -0.3070209482060875], 
          'ascension and tristan da cunha saint helena' : [0.017794624732961672, -0.04707518600206484], 
          'saint helena'                                : [0.017794624732961672, -0.04707518600206484], 
          'svalbard and jan mayen'                      : [-1.2274625594492559, 1.4487924134886185], 
          'sierra leone'                                : [0.03532298851152049, 0.02419297639975504], 
          'san marino'                                  : [-0.07408733130405842, 0.16803408946655907], 
          'somalia'                                     : [-0.0474860042872276, -0.038635758268878106], 
          'saint pierre and miquelon'                   : [0.7210394264465023, 0.24322863286274554], 
          'serbia'                                      : [-0.13088064810416, 0.17178762562897987], 
          'sao tome and principe'                       : [-0.020009488357615623, 0.0024468880238415203], 
          'suriname'                                    : [0.27775890923124535, 0.013196766896128587], 
          'slovakia'                                    : [-0.14735317737565268, 0.20501199296931105], 
          'slovenia'                                    : [-0.09812718979212676, 0.18379092395343122], 
          'sweden'                                      : [-0.2890444630995752, 0.3869653517174356], 
          'swaziland'                                   : [-0.3373480022034414, 0.09088264168728344], 
          'seychelles'                                  : [-0.3374178148874023, 0.09091881315951511], 
          'syrian arab republic'                        : [-0.21400370895658938, 0.12374319161406078], 
          'syria'                                       : [-0.21400370895658938, 0.12374319161406078], 
          'turks and caicos islands'                    : [0.9858076473011437, 0.1139320957891563], 
          'chad'                                        : [-0.06048157246681285, 0.045854221709435095], 
          'togo'                                        : [-0.002433482719502611, 0.02457874575933694], 
          'tajikistan'                                  : [-1.6440276726620482, 0.2853709190770175], 
          'turkmenistan'                                : [-0.6147989916227772, 0.17904013642456817], 
          'trinidad and tobago'                         : [0.37552310851588544, 0.037974752310514504], 
          'tunisia'                                     : [-0.04191842817066416, 0.1138278782761617], 
          'turkey'                                      : [-0.20931421708340991, 0.1455560715132691], 
          'tuvalu'                                      : [0.0, -0.023648336913748125], 
          'taiwan'                                      : [-0.04746376201478153, 0.22100242705447215], 
          'united republic of tanzania'                 : [-0.1418512229147595, -0.02044226785660097], 
          'tanzania'                                    : [-0.1418512229147595, -0.02044226785660097], 
          'uganda'                                      : [-0.10608882579080614, 0.004032726326311131], 
          'ukraine'                                     : [-0.25223379250289213, 0.2081418020325856], 
          'uruguay'                                     : [0.4162106616141088, -0.1300190452232428], 
          'uzbekistan'                                  : [-0.9467614629635648, 0.22797050422329335], 
          'holy see'                                    : [-0.06878220988565076, 0.15523277271964275], 
          'saint vincent and the grenadines'            : [0.3856524487487718, 0.04676136513986506], 
          'bolivarian republic of venezuela'            : [0.513655425473786, 0.03224462028224906], 
          'venezuela'                                   : [0.513655425473786, 0.03224462028224906], 
          'british virgin islands'                      : [0.5091883049988439, 0.07114741356858545], 
          'u.s. virgin islands'                         : [0.5091883049988439, 0.07114741356858545], 
          'us virgin islands'                           : [0.5091883049988439, 0.07114741356858545], 
          'yemen'                                       : [-0.2147729441866133, 0.049480477394521216], 
          'south africa'                                : [-0.1316491821959076, -0.1194854970140824], 
          'south america'                               : [0.3681875161144248, -0.08180770014030969], 
          'africa'                                      : [-0.04403093332739694, 0.0], 
          'europe'                                      : [-0.1353671442358877, 0.2442625862960881], 
          'zambia'                                      : [-0.09319457156195199, -0.03916450017436013], 
          'zimbabwe'                                    : [-0.1051150774390841, -0.05810307387573488]
          }
...
def mtg_extract_data_sector_from_region(latmin, latmax, verbose = True):
    '''
    Finds and reads back trajectory netCDF file based on yyyymmdd date string.
    Args:
        latmin : Minimum latitude to constrain MTG downloaded data and processing 
        latmax : Minimum latitude to constrain MTG downloaded data and processing 
    Keywords:
        verbose     : IF keyword set (True), print verbose informational messages.              
    Returns:
        The sector as a string (Q1, Q2, Q3, Q4, H1, H2, T1, T2, T3) and the associated file numbers 
    '''
    if latmin > latmax:
      print('Minimum latitude must be smaller than maximum latitude!!')
      print(f"Min latitude set to {latmin}")
      print(f"Max latitude set to {latmax}")
      exit()
    ...
    if latmin > 17.0:
      sector = 'T3'
    elif latmin > -17.5 and latmax < 15.5:
      sector = 'T2'
    elif latmax < -15.0:
      sector = 'T1'
    ...
    if latmin > 25.0:
      sector = 'Q4'
    elif latmin > -1.0 and latmax < 25.0:
      sector = 'Q3'
    elif latmin > -27.0 and latmax < 1.0:
      sector = 'Q2'
    elif latmax < -24.0:
      sector = 'Q1'
